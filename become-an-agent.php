          ...
          <div class="row justify-content-center align-items-lg-center">
            <div class="col-md-8 col-lg-6 mb-7 mb-lg-0">
              ...
              <div class="pe-lg-3 mb-7">
                <h1 class="display-3 text-white mb-3 mb-md-5">Become a<br>GDIS
                  <span class="text-warning">Agent</span>
                </h1>
                <p class="lead text-white-70">We give our agents the best prices and take fair commissions, this allows them to compete favourably among other agents and still be profitable.</p>
              </div>
              <!-- End Heading -->
                  ...
                  <div class="card-body">
                    <div class="row align-items-sm-center mb-5">
                      <div class="col-sm-auto order-sm-2 mb-3 mb-sm-0">
                        <img class="avatar avatar-xxl avatar-4x3" src="assets/img/illustrations/chat.png" alt="Image Description">
                      </div>
                      <!-- End Col -->

                      <div class="col-sm">
                        <h5 class="card-title">Fair pricing, Low commissions</h5>
                        <p class="card-text">Run your mobile money business with GDIS and make money with ease.</p>
                      </div>
                      <!-- End Col -->
                    </div>
                    <!-- End Row -->
                    ...
                    <form>
                      ...
                      <div class="mb-4">
                        <div class="row">
                          <div class="col-sm mb-4 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-lg" name="firstName" placeholder="Emeka" aria-label="Type your name" required data-msg="Please enter your name.">
                          ...
                          <div class="col-sm">
                            ...
                            <input type="text" class="form-control form-control-lg" name="lastName" placeholder="Odogwu" aria-label="Type your name" required data-msg="Please enter your name.">
                      ...
                      <div class="mb-4">
                        <div class="row">
                          <div class="col-sm mb-4 mb-sm-0">
                            ...
                            <input type="email" class="form-control form-control-lg" name="email" placeholder="example@gmail.com" aria-label="Type your name" required data-msg="Please enter your email.">
                          ...
                          <div class="col-sm">
                            ...
                            <input type="tel" class="form-control form-control-lg" name="phone" placeholder="0900 234 0000" aria-label="Type your name" required data-msg="Enter your phone number">
                      ...
                      <div class="mb-4">
                        <div class="row">
                          <div class="col-sm mb-4 mb-sm-0">
                            ...
                            <label class="form-label" for="registerEmail">Gender</label>
                          ...
                          <div class="col-sm">
                            ...
                            <label class="form-label" for="registerEmail">State</label>
                            <select class="form-select form-select-lg" aria-label=".form-select-lg example">
                      ...
                      <div class="d-grid text-center">
                        <button type="submit" class="btn btn-primary btn-lg">Register as an agent</button>
                        <span class="form-text">Need help? <a class="link" href="contact">Visit our Help Center <i class="bi-chevron-right small ms-1"></i></a></span>
                      </div>
                    </form>
                  </div>
                </div>
