          ...
          <div class="modal-body p-sm-5">
            ...
            <div id="signupModalFormLogin" style="display: none; opacity: 0;">
              ...
              <div class="d-grid gap-2">
                <a class="btn btn-white btn-lg" href="landing-business.html#">
                ...
                <a class="js-animation-link btn btn-primary btn-lg" href="landing-business.html#"
                   data-hs-show-animation-options='{
            ...
            <div id="signupModalFormSignupWithEmail" style="display: none; opacity: 0;">
              ...
              <form class="js-validate need-validate" novalidate>
                ...
                <div class="text-center">
                  <p class="small mb-0">By continuing you agree to our <a href="landing-business.html#">Terms and Conditions</a></p>
                </div>
              </form>
            </div>
