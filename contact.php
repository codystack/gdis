...
?>
    ...
    <main id="content" role="main">
      <!-- Hero -->
      <div class="shape-container bg-soft-primary-light">
            ...
            <div class="row">
              <div class="col-md-4 mb-5 mb-md-0">
                <div class="me-md-6">
                  ...
                  <a href="#contact">Get in touch <i class="bi-chevron-right small ms-1"></i></a>
                </div>
              </div>
              <!-- End Col -->
              ...
              <div class="col-md-4 mb-5 mb-md-0">
                <div class="me-md-6">
                  ...
                  <a href="#contact">Get help <i class="bi-chevron-right small ms-1"></i></a>
                </div>
              </div>
              <!-- End Col -->
              ...
              <div class="col-md-4">
                <div class="me-md-6">
                  ...
                  <a href="#contact">Become a partner <i class="bi-chevron-right small ms-1"></i></a>
                </div>
              </div>
              <!-- End Col -->
            </div>
      ...
      <!-- Contact Form -->
      <div class="container content-space-1 content-space-b-md-3" id="contact">
        <!-- Heading -->
        ...
        <div class="row justify-content-md-between">
                ...
                <form>
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <!-- Form -->
                      <div class="mb-4">
                        <label class="form-label" for="contactsFormLastName">Last Name</label>
                  ...
                  <div class="row">
                    <div class="col-sm-6 mb-4 mb-sm-0">
                      <!-- Form -->
                      <div class="mb-4">
                        <label class="form-label" for="contactsFormEmail">Email</label>
                        <input type="email" class="form-control" name="email" id="contactsFormEmail" placeholder="example@gmail.com" aria-label="example@gmail.com">
                      </div>
                      <!-- End Form -->
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="col-sm-6">
                      <!-- Form -->
                      <div class="mb-4">
                        <label class="form-label" for="contactsFormPhone">Phone</label>
                        <input type="tel" class="form-control" name="phone" id="contactsFormCompanyPhone" placeholder="0801 234 8765" aria-label="0801 234 8765">
                      </div>
                      <!-- End Form -->
                    </div>
                    <!-- End Col -->
          ...
          <div class="col-md-6 col-lg-5">
            ...
            <ul class="list-unstyled list-py-1">
              <li>
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0 text-center" style="width: 1.5rem;">
                    <img class="avatar avatar-xss avatar-circle" src="assets/vendor/flag-icon-css/flags/1x1/ng.png" alt="Image description"/>
                  </div>
                  <div class="flex-grow-1 ms-2">
                    <span>Onitsha, Anambra (HQ)</span>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    <span>Ibekwe street, No 138 Awka Rd, 430231, Onitsha</span>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    <span>+234 01 888 0285 or 0802 784 2020</span>
                  </div>
                </div>
              </li>
            </ul>
            ...
            <div class="mt-5">
              ...
              <p>If you wish to write us an email instead please use <a href="mailto:info@gdisagency.com">info@gdisagency.com</a></p>
            </div>
          </div>
          <!-- End Col -->
        </div>
