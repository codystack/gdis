          ...
          <div class="row justify-content-center align-items-md-center mb-7">
            <div class="col-md-6 mb-7 mb-md-0">
              ...
              <div class="pe-lg-3 mb-7">
                <h1 class="display-3 text-white mb-3 mb-md-5">The simpler, safer way to save online.</h1>
                <p class="text-white-70">Join the 1k+ active savers making their goals come through using GDIS.</p>
              </div>
            ...
            <div class="col-sm-10 col-md-6">
              <img class="img-fluid" src="assets/img/howitworks.jpg" alt="Image Description">
            </div>
            <!-- End Col -->
          </div>
