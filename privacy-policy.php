      ...
      <div class="container content-space-1 content-space-md-2">
        ...
        <div class="card card-lg">
          ...
          <div class="card-header bg-primary-dark position-relative overflow-hidden">
            ...
            <p class="card-text text-white">Last modified: September 27, 2021 (view archived versions)</p>
          ...
          <div class="card-body">
            <div class="mb-7">
              ...
              <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("GDIS"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.</p>
            ...
            <div class="mb-7">
              ...
              <p>GDIS's privacy policies explain how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that GDIS can use such data in accordance with our privacy policies.</p>
              ...
              <p>We provide information to help copyright holders manage their intellectual property online. If you think somebody is violating your copyrights and want to notify us, you can find information about submitting notices and GDIS's policy about responding to notices in our Help Center.</p>
            </div>
            ...
            <div class="mb-7">
              ...
              <p>When you upload, submit, store, send or receive content to or through our Services, you give GDIS (and those we work with) a worldwide license to use, host, store, reproduce, modify, create derivative works (such as those resulting from translations, adaptations or other changes we make so that your content works better with our Services), communicate, publish, publicly perform, publicly display and distribute such content. The rights you grant in this license are for the limited purpose of operating, promoting, and improving our Services, and to develop new ones. This license continues even if you stop using our Services (for example, for a business listing you have added to GDIS Maps). Some Services may offer you ways to access and remove content that has been provided to that Service. Also, in some of our Services, there are terms or settings that narrow the scope of our use of the content submitted in those Services. Make sure you have the necessary rights to grant us this license for any content that you submit to our Services.</p>
            </div>
          </div>
          <!-- End Card Body -->
        </div>
