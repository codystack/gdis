...
?>
    ...
    <main id="content" role="main">
          ...
          <div class="row justify-content-lg-between">
            <div class="col-md-7 position-relative zi-1 content-space-1 content-space-md-3">
              ...
              <div class="w-lg-85">
                <form>
                  ...
                  <div class="row gx-2">
                    ...
                    <div class="col-sm-auto">
                      <div class="d-grid">
                        <button class="btn btn-primary btn-lg" type="button" id="emailAddOn">Get Started Now</button>
                      </div>
                    </div>
                  </div>
                  <!-- End Input Group -->
                ...
                <div class="form-text">Saving can be much more than storing money. Automate your savings and earn awesome returns. No penalties. No fees. Absolutely free.</div>
            ...
            <div class="col-md-5 banner-half-end">
              <!-- Images -->
              <div class="d-none d-md-block bg-img-center h-100" style="background-image: url('assets/img/saveimg.jpg');"></div>
              <div class="d-md-none w-75 mx-auto ms-sm-auto">
                <img class="img-fluid" src="assets/img/saveimg.jpg" alt="Image Description">
              </div>
              <!-- End Images -->
            </div>
            <!-- End Col -->
      ...
      <!-- Icon Blocks -->
      <div id="scrollToContent" class="container content-space-1">
        <!-- Heading -->
        <div class="w-lg-65 text-center mx-lg-auto mb-7">
          <h3>Savings Made Easier</h3>
        ...
        <div class="row">
          <div class="col-md-4 mb-5 mb-md-0">
            <div class="me-md-6">
              ...
              <p>Save money on your terms from daily, monthly and annual savings. We’ll reward your discipline with juicy returns.</p>
      ...
      <div class="container content-space-1">
        <div class="text-center">
          <img class="mb-5" src="assets/img/illustrations/hi-five.png" alt="Illustration" style="width: 12.5rem;">
        </div>

        <!-- Heading -->
        <div class="w-lg-65 text-center mx-lg-auto mb-7">
          <h3>Start your saving journey with GDIS</h3>
          <p class="fs-6">Hit financial goals quicker and stronger by saving.</p>
        </div>
        <!-- End Heading -->

        <div class="text-center">
          <a class="btn btn-primary" href="auth/login">Create free account</a>
        </div>
      </div>
      <!-- End CTA -->
    </main>
