    ...
    <main id="content" role="main">
      ...
      <div class="bg-primary-dark overflow-hidden">
        <div class="container position-relative content-space-1 content-space-md-2">
          ...
          <p class="text-white">Updated: 29th September 2021</p>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-lg-9">
            ...
            <div id="linksToOtherWebsInfo" class="mb-7">
              ...
              <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by GDIS.</p>

              <p>GDIS has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that GDIS shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
