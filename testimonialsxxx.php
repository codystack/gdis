          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="hs-has-mega-menu nav-item"
                ...
                <a id="landingsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " aria-current="page" href="page-customer-stories.html#" role="button" aria-expanded="false">Landings</a>
              ...
              <!-- Pages -->
              <li class="hs-has-mega-menu nav-item">
                <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" href="page-customer-stories.html#" role="button" aria-expanded="false">Pages</a>
              ...
              <li class="hs-has-sub-menu nav-item">
                <a id="blogMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " href="page-customer-stories.html#" role="button" aria-expanded="false">Blog</a>
              ...
              <li class="hs-has-mega-menu nav-item"
                ...
                <a id="docsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " href="page-customer-stories.html#" role="button" aria-expanded="false">Docs</a>
                  ...
                  <a class="navbar-dropdown-menu-media-link" href="documentation/index.html">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <span class="navbar-dropdown-menu-media-title">Documentation <span class="badge bg-primary rounded-pill ms-1">v2.0</span></span>
      ...
      <div class="shape-container">
        <div class="bg-soft-warning position-relative overflow-hidden">
          <div class="container content-space-2 content-space-b-md-3">
            <div class="row justify-content-center align-items-lg-center mb-10">
              <div class="col-lg-6 mb-7 mb-lg-0">
                <div class="mb-7">
                  <h1 class="display-3 text-primary">You’re in great <span class="text-warning">company</span></h1>
                  <p class="lead">Join thousands of companies who rely on Space to turn idea into business.</p>
                </div>
              ...
              <div class="col-lg-6">
                <div class="w-85 mx-auto">
                  <img class="img-fluid" src="assets/img/illustrations/chat-with-bg-colors.png" alt="Image Description">
                </div>
              </div>
              <!-- End Col -->
            </div>
            ...
            <div class="row">
              <div class="col py-3">
                <img src="assets/svg/brands/capsule-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="assets/svg/brands/fitbit-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="assets/svg/brands/vidados-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="assets/svg/brands/mailchimp-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="assets/svg/brands/layar-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->
            </div>
            <!-- End Row -->
          ...
          <div class="position-absolute" style="bottom: -5rem; right: 7rem;">
            <img src="assets/svg/components/shape-7.svg" alt="SVG" width="150">
          </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Capsule scales at speed with Space</a></h5>
                <p class="card-text">Capsule has turned payments into a competitive advantage working with Space, allowing it to scale at speed across multiple markets.</p>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img4.jpg" alt="Image Description">
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">How Space supports Fitbit transformation</a></h5>
                <p class="card-text">FitBit empowers marketers to create digital marketing dashboards easily and share them with their team.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img5.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="assets/svg/brands/hubspot-primary.svg" alt="Logo">
                  </div>
                </div>
              </div>

              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Building the Perfect Solution for HubSpot</a></h5>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img6.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="assets/svg/brands/google-primary.svg" alt="Logo">
                  </div>
                </div>
              </div>

              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Google’s knowledge base keeps everyone informed and aligned</a></h5>
                <p class="card-text">Space’s ease of use is one of its hallmarks. It helps you visually navigate content and remember where something is.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img7.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="assets/svg/brands/embark-primary.svg" alt="Logo">
                  </div>
                </div>
              </div>

              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Embark's operating system drives remote collaboration</a></h5>
                <p class="card-text">Most task management apps — like Clickup or Trello — are just pointing to the work that lives scattered in other places.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img8.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="assets/svg/brands/amazon-primary.svg" alt="Logo">
                  </div>
                </div>
              </div>

              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Space boosts Amazon’s revenue by 7%</a></h5>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img9.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="assets/svg/brands/kaplan-primary.svg" alt="Logo">
                  </div>
                </div>
              </div>

              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Kaplan scales at speed with Space</a></h5>
                <p class="card-text">Kaplan has turned payments into a competitive advantage working with Space, allowing it to scale at speed across multiple markets.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img10.jpg" alt="Image Description">
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="assets/img/600x400/img11.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="assets/svg/brands/shopify-primary.svg" alt="Logo">
                  </div>
                </div>
              </div>
          ...
          <div class="row col-sm-divider">
            <div class="col-sm-4">
              ...
              <div class="text-center p-3">
                <img class="img-fluid" src="assets/img/illustrations/hi-five.png" alt="Image Description" style="height: 7rem;">
            ...
            <div class="col-sm-4">
              <!-- Info -->
              <div class="text-center p-3">
                <img class="img-fluid" src="assets/img/illustrations/review.png" alt="Image Description" style="height: 7rem;">
            ...
            <div class="col-sm-4">
              <!-- Info -->
              <div class="text-center p-3">
                <img class="img-fluid" src="assets/img/illustrations/graphs.png" alt="Image Description" style="height: 7rem;">
      ...
      <div class="container content-space-b-1 content-space-b-md-3">
        <div class="text-center mx-auto" style="max-width: 35rem;">
          <div class="row justify-content-center">
            ...
            <div class="col text-center py-3">
              <img class="avatar avatar-lg avatar-4x3" src="assets/svg/brands/business-insider-primary.svg" alt="Logo">
            </div>
            <!-- End Col -->
              ...
              <form>
                ...
                <div class="input-card input-card-sm mb-3">
                  <div class="input-card-form">
                    ...
                    <input type="text" class="form-control" id="requestDemoForm" placeholder="Enter business email" aria-label="Enter business email">
                  </div>
                  <button type="button" class="btn btn-primary btn-lg">Request a demo</button>
                </div>
                <!-- End Input Card -->
        ...
        <div class="row content-space-1">
          <div class="col-lg-3 mb-7 mb-lg-0">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item d-flex align-items-center active" href="page-customer-stories.html#">
                  <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/us.svg" alt="Image description" width="16"/>
                  <span>English (US)</span>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="page-customer-stories.html#">
          ...
          <div class="col-sm mb-7 mb-sm-0">
            ...
            <ul class="list-unstyled list-py-1 mb-0">
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Blog</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Guidance</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Customer Stories</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Support <i class="bi-box-arrow-up-right ms-1"></i></a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">API</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Packages</a></li>
            </ul>
            <!-- End List -->
          </div>
          <!-- End Col -->
          ...
          <div class="col-sm mb-7 mb-sm-0">
            ...
            <!-- List -->
            <ul class="list-unstyled list-py-1 mb-0">
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Belonging <i class="bi-box-arrow-up-right ms-1"></i></a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Company</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Careers <span class="badge bg-warning text-dark rounded-pill ms-2">We're hiring</span></a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Contacts</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Security</a></li>
            </ul>
            <!-- End List -->
          </div>
          <!-- End Col -->
          ...
          <div class="col-sm">
            ...
            <!-- List -->
            <ul class="list-unstyled list-py-1 mb-0">
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Web</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Mobile</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">iOS</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Android</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Figma Importing</a></li>
            </ul>
            <!-- End List -->
          </div>
          <!-- End Col -->
          ...
          <div class="col-sm">
            ...
            <ul class="list-unstyled list-py-1 mb-5">
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Terms of use</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Privacy policy <i class="bi-box-arrow-up-right ms-1"></i></a></li>
            </ul>
            <!-- End List -->
            ...
            <!-- List -->
            <ul class="list-unstyled list-py-1 mb-0">
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Documentation</a></li>
              <li><a class="link-sm link-light" href="page-customer-stories.html#">Snippets</a></li>
            </ul>
            <!-- End List -->
          </div>
          <!-- End Col -->
          ...
          <div class="col-md d-md-flex justify-content-md-end">
            ...
            <ul class="list-inline mb-0">
              <li class="list-inline-item">
                <a class="btn btn-icon btn-sm btn-soft-light rounded-circle" href="page-customer-stories.html#">
          ...
          <div class="modal-body p-sm-5">
            ...
            <div id="signupModalFormLogin" style="display: none; opacity: 0;">
              ...
              <div class="d-grid gap-2">
                <a class="btn btn-white btn-lg" href="page-customer-stories.html#">
                ...
                <a class="js-animation-link btn btn-primary btn-lg" href="page-customer-stories.html#"
                   data-hs-show-animation-options='{
            ...
            <div id="signupModalFormSignupWithEmail" style="display: none; opacity: 0;">
              ...
              <form class="js-validate need-validate" novalidate>
                ...
                <div class="text-center">
                  <p class="small mb-0">By continuing you agree to our <a href="page-customer-stories.html#">Terms and Conditions</a></p>
                </div>
              </form>
            </div>
